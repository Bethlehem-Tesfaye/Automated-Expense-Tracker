...
const formatCurrency = (amount, currencyCode) => new Intl.NumberFormat("en-US", {
    style: "currency",
...
const weekdayLabel = (date) => date.toLocaleString("en-US", { weekday: "short", timeZone: "UTC" });
...
const getWeeklyTotals = async (userId) => {
    ...
    const midnightUtc = Date.UTC(today.getUTCFullYear(), today.getUTCMonth(), today.getUTCDate(), 0, 0, 0, 0);
